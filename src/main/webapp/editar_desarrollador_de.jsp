    ...
    <form action="gestion_desarrolladores_de.jsp" method="POST">
        <div class="row mb-4">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="nombre" value="Luis Gerardo" required>
            </div>
            <div class="col-md-4">
                <label class="form-label">Apellido Paterno <span class="text-danger">*</span> :</label>
                <input type="text" class="form-control" name="apellido_paterno" value="Barron" required>
            </div>
            <div class="col-md-4">
                <label class="form-label">Apellido Materno <span class="text-danger">*</span> :</label>
                <input type="text" class="form-control" name="apellido_materno" value="Flores" required>
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="telefono" value="7771234512" required>
            </div>
        </div>
        ...
        <div class="row mb-5">
            <div class="col-md-4">
                ...
                <input type="email" class="form-control" name="correo" value="ejemplo@gmail.com" required>
            </div>
            <div class="col-md-4">
                <label class="form-label">Contraseña <span class="text-danger">*</span> :</label>
                <div class="password-container">
                    <input type="password" class="form-control" name="contrasena" id="pass1" value="contrasena123" required>
            ...
            <div class="col-md-4">
                ...
                <div class="password-container">
                    <input type="password" class="form-control" name="confirmar_contrasena" id="pass2" value="contrasena123" required>
